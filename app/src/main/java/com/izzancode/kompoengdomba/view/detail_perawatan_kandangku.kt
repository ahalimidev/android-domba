...
class detail_perawatan_kandangku : AppCompatActivity() {
    ...
    private var rKandangkuAdapter : detail_perawatan_kandangkuAdapter? = null
    var tgl_awal : String = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialog = progressDialog(this@detail_perawatan_kandangku)
    ...
    private fun dialog() {
        val dialog = Dialog(this@detail_perawatan_kandangku)
        ...
        x.btKirim.setOnClickListener {
            if (tgl_awal == "" && tgl_akhir == "") {
                Toast.makeText(
                    this@detail_perawatan_kandangku,
        ...
        lifecycleScope.launch {
            try {
                ...
                if (authResponse.body()!!.success == 1) {
                    ...
                    Glide.with(this@detail_perawatan_kandangku)
                        .load(foto)
                    ...
                    val linearLayoutManager = LinearLayoutManager(this@detail_perawatan_kandangku, LinearLayoutManager.VERTICAL, false)
                    linearLayoutManager.scrollToPositionWithOffset(0, 0)
                    rKandangkuAdapter = detail_perawatan_kandangkuAdapter(this@detail_perawatan_kandangku,result_all)
                    ...
                    binding.ivGambar.setOnClickListener {
                        startActivity(Intent(this@detail_perawatan_kandangku,com.izzancode.kompoengdomba.view.foto::class.java).putExtra("foto", foto_kambing +result_one.fv_image))
                    }
                }else{
                    dialog.dismiss()
