...
class detail_kelahiran_kandangku : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialog = progressDialog(this@detail_kelahiran_kandangku)
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                if (authResponse.body()!!.success == 1) {
                    ...
                    Glide.with(this@detail_kelahiran_kandangku)
                        .load(foto)
                    ...
                    binding.ivGambar.setOnClickListener {
                        startActivity(Intent(this@detail_kelahiran_kandangku,com.izzancode.kompoengdomba.view.foto::class.java).putExtra("foto", foto_kambing +result.fv_image))
                    }
                } else {
                    dialog.dismiss()
                    Toast.makeText(
                        this@detail_kelahiran_kandangku,
