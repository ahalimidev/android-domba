...
import com.izzancode.kompoengdomba.adapter.detail_perkembangan_titip_angonAdapteer
...
class detail_perkembangan_titip_angon : AppCompatActivity() {
    ...
    private var rAdapter : detail_perkembangan_titip_angonAdapteer? = null
    var tgl_awal : String = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialog = progressDialog(this@detail_perkembangan_titip_angon)
    ...
    private fun dialog() {
        val dialog = Dialog(this@detail_perkembangan_titip_angon)
        ...
        x.btKirim.setOnClickListener {
            if (tgl_awal == "" && tgl_akhir == "") {
                Toast.makeText(
                    this@detail_perkembangan_titip_angon,
        ...
        lifecycleScope.launch {
            try {
                ...
                if (authResponse.body()!!.success == 1) {
                    ...
                    Glide.with(this@detail_perkembangan_titip_angon)
                        .load(foto)
                    ...
                    val linearLayoutManager = LinearLayoutManager(this@detail_perkembangan_titip_angon, LinearLayoutManager.VERTICAL, false)
                    linearLayoutManager.scrollToPositionWithOffset(0, 0)
                    rAdapter = detail_perkembangan_titip_angonAdapteer(this@detail_perkembangan_titip_angon,result_all)
                    ...
                    binding.ivGambar.setOnClickListener {
                        startActivity(Intent(this@detail_perkembangan_titip_angon,com.izzancode.kompoengdomba.view.foto::class.java).putExtra("foto", foto_kambing +result_one.fv_image))
                    }
                }else{
                    dialog.dismiss()
