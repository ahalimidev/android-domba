...
class detail_kesehetan_kandangku : AppCompatActivity() {
    ...
    private var rKandangkuAdapter : detail_kesehatan_kandangkuAdapter? = null
    var tgl_awal : String = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialog = progressDialog(this@detail_kesehetan_kandangku)
    ...
    private fun dialog() {
        val dialog = Dialog(this@detail_kesehetan_kandangku)
        ...
        x.btKirim.setOnClickListener {
            if (tgl_awal == "" && tgl_akhir == "") {
                Toast.makeText(
                    this@detail_kesehetan_kandangku,
        ...
        lifecycleScope.launch {
            try {
                ...
                if (authResponse.body()!!.success == 1) {
                    ...
                    Glide.with(this@detail_kesehetan_kandangku)
                        .load(foto)
                    ...
                    val linearLayoutManager = LinearLayoutManager(this@detail_kesehetan_kandangku, LinearLayoutManager.VERTICAL, false)
                    linearLayoutManager.scrollToPositionWithOffset(0, 0)
                    rKandangkuAdapter = detail_kesehatan_kandangkuAdapter(this@detail_kesehetan_kandangku,result_all)
                    ...
                    binding.ivGambar.setOnClickListener {
                        startActivity(Intent(this@detail_kesehetan_kandangku,com.izzancode.kompoengdomba.view.foto::class.java).putExtra("foto", foto_kambing +result_one.fv_image))
                    }
                }else{
                    dialog.dismiss()
