...
class detail_ternak_titip_angon : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialog = progressDialog(this@detail_ternak_titip_angon)
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                if (authResponse.body()!!.success == 1) {
                    ...
                    Glide.with(this@detail_ternak_titip_angon)
                        .load(foto)
                    ...
                    binding.ivGambar.setOnClickListener {
                        startActivity(Intent(this@detail_ternak_titip_angon,com.izzancode.kompoengdomba.view.foto::class.java).putExtra("foto", foto_kambing +result.fv_image))
                    }
                } else {
                    dialog.dismiss()
                    Toast.makeText(
                        this@detail_ternak_titip_angon,
