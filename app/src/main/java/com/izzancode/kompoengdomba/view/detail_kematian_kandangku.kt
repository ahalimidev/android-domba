...
class detail_kematian_kandangku : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialog = progressDialog(this@detail_kematian_kandangku)
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                if (authResponse.body()!!.success == 1) {
                    ...
                    Glide.with(this@detail_kematian_kandangku)
                        .load(foto)
                    ...
                    binding.ivGambar.setOnClickListener {
                        startActivity(Intent(this@detail_kematian_kandangku,com.izzancode.kompoengdomba.view.foto::class.java).putExtra("foto", foto_kambing +result.fv_image))
                    }
                } else {
                    dialog.dismiss()
                    Toast.makeText(
                        this@detail_kematian_kandangku,
