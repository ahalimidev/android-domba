...
class list_perawatan_kandangkuAdapter(private val context: Context, results: ArrayList<perawatan>) : RecyclerView.Adapter<list_perawatan_kandangkuAdapter.MyViewHolder>() {
