...
class detail_perawatan_titip_angonAdapter(private val context: Context, results: ArrayList<perawatan>) : RecyclerView.Adapter<detail_perawatan_titip_angonAdapter.MyViewHolder>() {
