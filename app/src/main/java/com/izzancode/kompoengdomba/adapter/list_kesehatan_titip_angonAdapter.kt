...
class list_kesehatan_titip_angonAdapter(private val context: Context, results: ArrayList<kesehatan>) : RecyclerView.Adapter<list_kesehatan_titip_angonAdapter.MyViewHolder>() {
