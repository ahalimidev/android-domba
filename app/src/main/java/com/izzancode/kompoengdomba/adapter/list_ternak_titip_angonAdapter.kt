...
class list_ternak_titip_angonAdapter(private val context: Context, results: ArrayList<ternak>) : RecyclerView.Adapter<list_ternak_titip_angonAdapter.MyViewHolder>() {
