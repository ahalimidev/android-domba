...
class list_kematian_kandangkuAdapter(private val context: Context, results: ArrayList<kematian>) : RecyclerView.Adapter<list_kematian_kandangkuAdapter.MyViewHolder>() {
