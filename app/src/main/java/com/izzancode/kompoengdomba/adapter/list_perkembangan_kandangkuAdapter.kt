...
class list_perkembangan_kandangkuAdapter(private val context: Context, results: ArrayList<perkembangan>) : RecyclerView.Adapter<list_perkembangan_kandangkuAdapter.MyViewHolder>() {
