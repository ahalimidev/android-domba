...
class detail_perkembangan_titip_angonAdapteer(private val context: Context, results: ArrayList<perkembangan>) : RecyclerView.Adapter<detail_perkembangan_titip_angonAdapteer.MyViewHolder>() {
