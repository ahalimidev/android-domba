...
import com.izzancode.kompoengdomba.view.detail_kematian_kandangku

class list_kematian_titip_angonAdapter(private val context: Context, results: ArrayList<kematian>) : RecyclerView.Adapter<list_kematian_titip_angonAdapter.MyViewHolder>() {

    private var Items = ArrayList<kematian>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        with(holder) {
            ...
            holder.itemView.setOnClickListener {
                context.startActivity(Intent(context, detail_kematian_kandangku::class.java).putExtra("id",result.fn_sheepid))
