...
class list_kelahiran_kandangkuAdapter(private val context: Context, results: ArrayList<kelahiran>) : RecyclerView.Adapter<list_kelahiran_kandangkuAdapter.MyViewHolder>() {
