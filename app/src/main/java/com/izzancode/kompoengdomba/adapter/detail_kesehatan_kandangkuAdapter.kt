...
class detail_kesehatan_kandangkuAdapter(private val context: Context, results: ArrayList<kesehatan>) : RecyclerView.Adapter<detail_kesehatan_kandangkuAdapter.MyViewHolder>() {
